...
This script shows basic integration of PlainVanillaOption and DigitalOption classes with Plotter class. Price, P&L and
first-order greeks plots are shown for plain-vanilla and digital option contracts.
"""
...
from pyblackscholesanalytics.plotter.holoviews import HoloviewsOptionPlotter
...
def main():
    ...
    plotter = HoloviewsOptionPlotter(option)
