...
Jupyter Notebooks are available in GitHub, rendered statically with Jupyter nbviewer and made interactive on your web browser thanks to [Binder](https://mybinder.org/)

|  | Jupyter Notebook GitHub | Jupyter Notebook nbviewer | Jupyter Notebook Binder | Youtube Video Playlist |
|:-------------------|:--------------------------:|:--------------------------:|:--------------------------:|:------------------:|
